...
return [
	...
	'faq section' => '
			...
			<p>Несколько формул удобнее набирать на этой странице. Текст с формулами набирайте в <a href="https://upmath.me/">редакторе с поддержкой маркдаун-разметки</a> и получайте готовый html-код. Сайты с&nbsp;математическими текстами могут использовать сервис напрямую.</p>
	',
	'embedding section 1' => '
